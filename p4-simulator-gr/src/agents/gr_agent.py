...
class GrAgent(object):
    ...
    def setCostDif(self, index):
        ...
        #print ('setCostDif', index, self.costdif)
    ...
    def getProbs(self, model, start, goals, obs):
        ...
        for goal in goals:
            ...
            goal.cost = round(self.helper.getCost(self.model, start, goal.coord), 5)
            #print('p=',goal.p,'t=',goal.t, 'c=',goal.cost)
    ...
    def cd_minimal_2(self, start, goal, obs):
        ...
        try:
            ...
            self.setNewOptcost(start, goal)
            print "cd_minimal_2 except"
            optc_sg = GrAgent.opt_costs[goal]
        #print("optc_sg=",optc_sg),
        optc_ng = round(self.helper.getCost(self.model, obs[len(obs) - 1], goal), 5)
        #print("optc_ng=",optc_ng),
        costdif = optc_ng - optc_sg
        #print("costdif=",costdif)
    ...
    def calcProbability(self, delta):
        ...
        p = likelihood_ratio / (1.0 + likelihood_ratio)
        #print ('likelihood_ratio',likelihood_ratio,'p',p)
